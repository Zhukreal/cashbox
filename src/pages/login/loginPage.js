    ...
    if(isExpiredSession || isFailureConnection) {
        return (
            <LoginContainer>
                ...
                <FormBox>
                    {isExpiredSession &&
                    <Text fz={15} mb={30}>Сессия была отключена так как вы бездействовали некоторое время</Text>}
                    {isFailureConnection &&
                    <Text fz={15} mb={30}>Сессия была отключена по причине отсутствия связи</Text>}
                    <EnterMobile>
