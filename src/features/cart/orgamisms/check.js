...
import {Input, Button, IconArrowLeft, StyledInput, FooterMobile, Print} from "ui"
...
export const Check = ({onClose, editable = {}}) => {
    ...
    const handleSendTicketEmail = async () => {
        ...
        try {
            ...
            await dispatch(cartActions.sendTicketEmail(currentReceipt.id))
        } catch (e) {
